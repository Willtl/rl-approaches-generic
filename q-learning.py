...
# Numb of cells plus the number of cells minus the number of seeds
...
if __name__ == '__main__':
    ...
    while cur_it < episodes:
        ...
        epsilon = 0.4 - cur_it * (0.4 / zero_eps_at)
        ...
        # print(new_matrix_state)
        # print(q_table[new_matrix_state])
        # print(current_q)
